      ...
      body: BlocBuilder<HomeCubit, HomeState>(
        builder: (context, state) {
          return state.loadingCatChildren
              ...
              : state.categoreyChildrenData!.categories == null
                  ? Center(
                      child: Column(
                      children: [
                  ...
                  : state.categoreyChildrenData!.categories!.isEmpty
                      ? Center(
                          child: Column(
                          children: [
                            Lottie.asset('assets/images/empty_data.json'),
                              ...
                              children: [
                                GridView.count(
                                  ...
                                  children: List.generate(
                                      state.categoreyChildrenData!.categories!
                                          .length, (index) {
                                                      ...
                                                      CategoriesScreen(
                                                          title: locale.locale
                                                              ...
                                                              : locale.locale
                                                                          .languageCode ==
                                                                      "ar"
                                                                  ? state.categoreyChildrenData!.categories![index].nameAr ??
                                                                      ""
                                                                  : state
                                                                          .categoreyChildrenData!
                                                                          .categories![

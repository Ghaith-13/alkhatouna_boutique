...
class ItemWidget extends StatefulWidget {
  ...
  const ItemWidget({super.key, required this.oneItem});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      widget.oneItem.productColor == null
                          ? SizedBox()
                          : widget.oneItem.productColor == "default"
                              ? SizedBox()
                              : Text(
                                  "${"Color".tr(context)} :",
                                  style: TextStyle(
                      ...
                      30.pw,
                      widget.oneItem.productSize == null
                          ? SizedBox()
                          : widget.oneItem.productSize == "default"
                              ? SizedBox()
                              : Text(
                                  "${"Size".tr(context)} :",
                                  style: TextStyle(
